...
class WC_Gateway_Buckaroo_EPS extends WC_Gateway_Buckaroo
{
    public function __construct()
    {
        ...
        $this->title                  = 'EPS';
        $this->icon = apply_filters('woocommerce_buckaroo_eps_icon', BuckarooConfig::getIconPath('24x24/eps.png', 'new/EPS.png'));
        $this->has_fields             = false;
        $this->method_title           = "Buckaroo EPS";
        $this->description            = "Betaal met EPS";
        ...
        if (version_compare(WOOCOMMERCE_VERSION, '2.0.0', '>=')) {
            ...
            add_action('woocommerce_api_wc_gateway_buckaroo_eps', array($this, 'response_handler'));
            $this->notify_url = add_query_arg('wc-api', 'WC_Gateway_Buckaroo_EPS', $this->notify_url);
        }
    }

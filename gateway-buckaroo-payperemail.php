...
class WC_Gateway_Buckaroo_PayPerEmail extends WC_Gateway_Buckaroo {
    ...
    function __construct() { 
        ...
        $this->description = "Betaal met PayPerEmail";
    ...
    public function process_refund( $order_id, $amount = null, $reason = '' ) {
        ...
        $payperemail->invoiceId = $order_id;
     ...
     */
    function process_payment($order_id, $paylink = false) {
        $woocommerce = getWooCommerceObject();
        ...
        $payperemail->invoiceId = (string)getUniqInvoiceId($order_id);

			...
			{ displayMode === 'dropdown' ? (
				...
				<div className="form-row form-row-wide buckaroo-paybybank-mobile">
					...
					>
						...
						{ Object.keys( payByBankIssuers ).map(
							( issuerCode ) => (
				...
				<div>
					...
					<div className="bk-paybybank-input bk-paybybank-not-mobile">
						<div
							className={ `form-row form-row-wide bk-paybybank-selector ${
								showAllBanks ? 'show-all' : ''
							}` }
						>
							{ Object.keys( payByBankIssuers ).map(
								( issuerCode ) => (
									<div
										className="custom-control custom-radio bank-control"
										key={ issuerCode }
									>
										<input
											type="radio"
										...
										>
											<img
												src={ `${ buckarooImagesUrl }ideal/${
													payByBankIssuers[
														issuerCode
													].logo ||
													'default-logo-filename.png'
												}` }
						...
						{ /* Toggle Button */ }
						<div
							className="bk-paybybank-toggle-list"

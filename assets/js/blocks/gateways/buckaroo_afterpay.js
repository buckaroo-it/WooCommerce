...
import AfterPayB2B from '../partials/buckaroo_afterpay_b2b'; // Import your AfterPayB2B component

const AfterPayView = ({ b2b, onCheckboxChange, onBirthdateChange,onCocInput,onCompanyInput,onAccountName }) => {
    ...
    return (
        <fieldset>
                ...
                {b2b == 'disable' && (<BirthDayField paymentMethod={paymentMethod} onBirthdateChange={handleBirthdateChange} />)}


                <TermsAndConditionsCheckbox paymentMethod={paymentMethod} onCheckboxChange={handleTermsCheckboxChange}
                                            labelText={labelText} termsUrl={termsUrl}/>

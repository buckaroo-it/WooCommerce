...
{
    public const NFC = \WC_Buckaroo_Normalizer::NFC;
    public const NFD = \WC_Buckaroo_Normalizer::NFD;
    public const NFKC = \WC_Buckaroo_Normalizer::NFKC;
    public const NFKD = \WC_Buckaroo_Normalizer::NFKD;
    ...
    public function folded(bool $compat = true): parent
    {
        ...
        if (!$compat || \PHP_VERSION_ID < 70300 || !\defined('WC_Buckaroo_Normalizer::NFKC_CF')) {
            $str->string = normalizer_normalize($str->string, $compat ? \WC_Buckaroo_Normalizer::NFKC : \WC_Buckaroo_Normalizer::NFC);
            $str->string = mb_strtolower(str_replace(self::FOLD_FROM, self::FOLD_TO, $this->string), 'UTF-8');
        } else {
            $str->string = normalizer_normalize($str->string, \WC_Buckaroo_Normalizer::NFKC_CF);
        }

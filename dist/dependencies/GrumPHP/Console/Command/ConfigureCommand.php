...
namespace WC_Buckaroo\Dependencies\GrumPHP\Console\Command;

use Exception;
use WC_Buckaroo\Dependencies\GrumPHP\Configuration\Resolver\TaskConfigResolver;
...
use WC_Buckaroo\Dependencies\Symfony\Component\Yaml\Yaml;
    ...
    public function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        if ($this->filesystem->exists($configFile) && !$force) {
            if (!$input->getOption('silent')) {
                $output->writeln('<fg=yellow>WC_Buckaroo\Dependencies\GrumPHP is already configured!</fg=yellow>');
            }
        ...
        if (!$input->getOption('silent')) {
            $output->writeln('<fg=green>WC_Buckaroo\Dependencies\GrumPHP is configured and ready to kick ass!</fg=green>');
        }

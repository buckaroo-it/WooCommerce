...
use WC_Buckaroo\Dependencies\GrumPHP\IO\ConsoleIO;
use WC_Buckaroo\Dependencies\GrumPHP\Locator\ChangedFiles;
use WC_Buckaroo\Dependencies\GrumPHP\Locator\StdInFiles;
use WC_Buckaroo\Dependencies\GrumPHP\Runner\TaskRunner;
use WC_Buckaroo\Dependencies\GrumPHP\Runner\TaskRunnerContext;
use WC_Buckaroo\Dependencies\GrumPHP\Task\Context\GitCommitMsgContext;
...
class CommitMsgCommand extends Command
{
    ...
    public function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $output->writeln('<fg=yellow>WC_Buckaroo\Dependencies\GrumPHP detected a commit-msg command.</fg=yellow>');

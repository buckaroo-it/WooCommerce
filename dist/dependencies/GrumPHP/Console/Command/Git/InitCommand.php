...
use WC_Buckaroo\Dependencies\GrumPHP\Configuration\Environment\DotEnvSerializer;
use WC_Buckaroo\Dependencies\GrumPHP\Configuration\Model\HooksConfig;
...
class InitCommand extends Command
{
    ...
    public function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $output->writeln('<fg=yellow>Watch out! WC_Buckaroo\Dependencies\GrumPHP is sniffing your commits!<fg=yellow>');
    ...
    /**
     * @throws \WC_Buckaroo\Dependencies\GrumPHP\Exception\FileNotFoundException
     */

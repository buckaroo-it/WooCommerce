...
namespace WC_Buckaroo\Dependencies\GrumPHP\Runner\Reporting;
...
use WC_Buckaroo\Dependencies\GrumPHP\Locator\AsciiLocator;
...
class RunnerReporter
{
    ...
    {
        $this->IO->write($this->IO->colorize(['WC_Buckaroo\Dependencies\GrumPHP is sniffing your code!'], 'yellow'));

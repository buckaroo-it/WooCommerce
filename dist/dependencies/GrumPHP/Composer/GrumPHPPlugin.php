...
class GrumPHPPlugin implements PluginInterface, EventSubscriberInterface
{
    ...
    public function detectGrumphpAction(PackageEvent $event): void
    {
        ...
        // Check all WC_Buckaroo\Dependencies\GrumPHP operations to see if they are unanimously removing WC_Buckaroo\Dependencies\GrumPHP
    ...
    {
        $this->io->writeError('<fg=red>WC_Buckaroo\Dependencies\GrumPHP can not sniff your commits! ('.$reason.')</fg=red>');
    }
}

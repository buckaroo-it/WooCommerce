...
namespace WC_Buckaroo\Dependencies\GrumPHP\Composer;
...
use WC_Buckaroo\Dependencies\Symfony\Component\Process\ProcessBuilder;

class DevelopmentIntegrator
{
    /**
     * This method makes sure that WC_Buckaroo\Dependencies\GrumPHP registers itself during development.
     */
    public static function integrate(Event $event): void
    {
        ...
        if (!$process->isSuccessful()) {
            $event->getIO()->write(
                '<fg=red>WC_Buckaroo\Dependencies\GrumPHP can not sniff your commits. Did you specify the correct git-dir?</fg=red>'
            );

 ...
 *
 * ``` php
 * $collection = new \WC_Buckaroo\Dependencies\Ramsey\Collection\Collection('My\\Foo');
 ...
 * namespace My\Foo;
 *
 * class FooCollection extends \WC_Buckaroo\Dependencies\Ramsey\Collection\AbstractCollection
 * {

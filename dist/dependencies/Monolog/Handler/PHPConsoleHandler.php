...
namespace WC_Buckaroo\Dependencies\Monolog\Handler;

use WC_Buckaroo\Dependencies\Monolog\Formatter\LineFormatter;
use WC_Buckaroo\Dependencies\Monolog\Formatter\FormatterInterface;
...
/**
 * WC_Buckaroo\Dependencies\Monolog handler for Google Chrome extension "PHP Console"
 *
 ...
 *
 *      $logger = new \WC_Buckaroo\Dependencies\Monolog\Logger('all', array(new \WC_Buckaroo\Dependencies\Monolog\Handler\PHPConsoleHandler()));
 *      \WC_Buckaroo\Dependencies\Monolog\ErrorHandler::register($logger);
 *      echo $undefinedVar;
 ...
 *
 * @phpstan-import-type Record from \WC_Buckaroo\Dependencies\Monolog\Logger
 * @deprecated Since 2.8.0 and 3.2.0, PHPConsole is abandoned and thus we will drop this handler in WC_Buckaroo\Dependencies\Monolog 4
 */
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    private $options = [
        ...
        'classesPartialsTraceIgnore' => ['WC_Buckaroo\Dependencies\Monolog\\'], // array Hide calls of classes started with...
    ...
    /**
     * @param  array<string, mixed> $options   See \WC_Buckaroo\Dependencies\Monolog\Handler\PHPConsoleHandler::$options for more details

...
namespace WC_Buckaroo\Dependencies\Monolog;

use DateTimeZone;
use WC_Buckaroo\Dependencies\Monolog\Handler\HandlerInterface;
use WC_Buckaroo\Dependencies\Psr\Log\LoggerInterface;
use WC_Buckaroo\Dependencies\Psr\Log\InvalidArgumentException;
use WC_Buckaroo\Dependencies\Psr\Log\LogLevel;
use Throwable;
use Stringable;

/**
 * WC_Buckaroo\Dependencies\Monolog log channel
 *
...
class Logger implements LoggerInterface, ResettableInterface
{
    ...
    /**
     * WC_Buckaroo\Dependencies\Monolog API version
     *
    ...
    /**
     * Mapping between levels numbers defined in RFC 5424 and WC_Buckaroo\Dependencies\Monolog ones
     *
     ...
     * there is no performance penalty and WC_Buckaroo\Dependencies\Monolog 2 enabled microseconds
     ...
     * Adds a log record.
     *
     * @param  int               $level    The logging level (a WC_Buckaroo\Dependencies\Monolog or RFC 5424 level)
     ...
     *
     * @throws \WC_Buckaroo\Dependencies\Psr\Log\InvalidArgumentException If level is not defined
     *
     * @phpstan-param  Level     $level
    ...
    /**
     * Converts PSR-3 levels to WC_Buckaroo\Dependencies\Monolog ones if necessary
     *

...
class LogstashFormatter extends NormalizerFormatter
{
    ...
    /**
     * @var string the key for 'extra' fields from the WC_Buckaroo\Dependencies\Monolog record
     */
    protected $extraKey;

    /**
     * @var string the key for 'context' fields from the WC_Buckaroo\Dependencies\Monolog record
     */

 ...
 * }
 *
 * @deprecated Use WC_Buckaroo\Dependencies\Amp\ByteStream\Payload instead.
 */
class Message implements InputStream, Promise
{
     ...
     *
     * This might be required to resolve a promise with an InputStream, because promises in WC_Buckaroo\Dependencies\Amp can't be resolved with
     * other promises.
     *
     * @return InputStream
     */

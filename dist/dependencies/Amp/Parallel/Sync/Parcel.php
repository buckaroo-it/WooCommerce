...
interface Parcel
{
     ...
     *
     * @return \WC_Buckaroo\Dependencies\Amp\Promise<mixed> Resolves with the return value of $callback or fails if $callback
     *     throws an exception.
     */
    public function synchronized(callable $callback): Promise;

    /**
     * @return \WC_Buckaroo\Dependencies\Amp\Promise<mixed> A promise for the value inside the parcel.
     */

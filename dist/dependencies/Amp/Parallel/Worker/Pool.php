...
interface Pool extends Worker
{
     ...
     *
     * @return \WC_Buckaroo\Dependencies\Amp\Parallel\Worker\Worker
     *
     * @throws \WC_Buckaroo\Dependencies\Amp\Parallel\Context\StatusError If the queue is not running.
     */

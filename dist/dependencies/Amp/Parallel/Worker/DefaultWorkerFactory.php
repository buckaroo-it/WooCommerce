...
use WC_Buckaroo\Dependencies\Amp\Parallel\Context\Thread;
...
final class DefaultWorkerFactory implements WorkerFactory
{
    ...
    /**
     * @param string $envClassName Name of class implementing \WC_Buckaroo\Dependencies\Amp\Parallel\Worker\Environment to instigate in each
     *     worker. Defaults to \WC_Buckaroo\Dependencies\Amp\Parallel\Worker\BasicEnvironment.
     *

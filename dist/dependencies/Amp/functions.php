...
namespace WC_Buckaroo\Dependencies\Amp
{
     ...
     * loop's error handler using `WC_Buckaroo\Dependencies\Amp\Promise\rethrow()`.
     *
...
namespace WC_Buckaroo\Dependencies\Amp\Promise
{

    use WC_Buckaroo\Dependencies\Amp\Deferred;
    use WC_Buckaroo\Dependencies\Amp\Loop;
    use WC_Buckaroo\Dependencies\Amp\MultiReasonException;
    ...
    use function WC_Buckaroo\Dependencies\Amp\Internal\createTypeError;
     ...
     *
     * @return void
     * @throws \TypeError If $promise is not an instance of \WC_Buckaroo\Dependencies\Amp\Promise or \React\Promise\PromiseInterface.
     *
     */
     ...
     * `WC_Buckaroo\Dependencies\Amp\TimeoutException`.
     *
     * @template TReturn
     *
...
namespace WC_Buckaroo\Dependencies\Amp\Iterator
{

    use WC_Buckaroo\Dependencies\Amp\Delayed;
    use WC_Buckaroo\Dependencies\Amp\Emitter;
    use WC_Buckaroo\Dependencies\Amp\Iterator;
    use WC_Buckaroo\Dependencies\Amp\Producer;
    use WC_Buckaroo\Dependencies\Amp\Promise;
    use function WC_Buckaroo\Dependencies\Amp\call;
    use function WC_Buckaroo\Dependencies\Amp\coroutine;
    use function WC_Buckaroo\Dependencies\Amp\Internal\createTypeError;

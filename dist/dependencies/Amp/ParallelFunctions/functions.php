...
namespace WC_Buckaroo\Dependencies\Amp\ParallelFunctions;
...
use WC_Buckaroo\Dependencies\Amp\Serialization\SerializationException;
...
use function WC_Buckaroo\Dependencies\Amp\Parallel\Worker\enqueue;
...
function parallelMap(array $array, callable $callable, Pool $pool = null): Promise
{
    return call(function () use ($array, $callable, $pool) {
        // WC_Buckaroo\Dependencies\Amp\Promise\any() guarantees that all operations finished prior to resolving. WC_Buckaroo\Dependencies\Amp\Promise\all() doesn't.

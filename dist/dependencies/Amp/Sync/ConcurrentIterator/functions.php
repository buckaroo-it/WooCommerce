...
namespace WC_Buckaroo\Dependencies\Amp\Sync\ConcurrentIterator;
...
use WC_Buckaroo\Dependencies\Amp\Sync\Barrier;
use WC_Buckaroo\Dependencies\Amp\Sync\Lock;
use WC_Buckaroo\Dependencies\Amp\Sync\Semaphore;
use function WC_Buckaroo\Dependencies\Amp\asyncCall;
...
function each(Iterator $iterator, Semaphore $semaphore, callable $processor): Promise
{
    ...
    // Use WC_Buckaroo\Dependencies\Amp\Iterator\discard in the future

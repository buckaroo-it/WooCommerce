...
namespace WC_Buckaroo\Dependencies\Doctrine\Deprecations;
 ...
 *    \WC_Buckaroo\Dependencies\Doctrine\Deprecations\Deprecation::enableTrackingDeprecations();
 *
 *  - Uses @trigger_error with E_USER_DEPRECATED
 *    \WC_Buckaroo\Dependencies\Doctrine\Deprecations\Deprecation::enableWithTriggerError();
 *
 *  - Sends deprecation messages via a PSR-3 logger
 *    \WC_Buckaroo\Dependencies\Doctrine\Deprecations\Deprecation::enableWithPsrLogger($logger);
 *

...
//            $tmp["ArticleVatcategory"] = 1;
    ...
    function process_payment($order_id) {
        ...
        if (isset($_POST["buckaroo-afterpaynew-shipping-differ"])) {
            // if (!empty($_POST["buckaroo-afterpaynew-shipping-differ"])) {
...
//        }
    ...
    public function init_form_fields() {
        ...
        //     'type' => 'select',
        //     'description' => __( 'This Afterpay version does not support company credentials yet', 'wc-buckaroo-bpe-gateway' ),
        //     'options' => array('disable'=>'Disable'),

    ...
    <ul>
        ...
        ?>
            <li class="bk-to-capture">
                ...
                <div class="cost bk-auto m-h-15">
                    <?php echo
                    wc_price($item->get_unit_price(), array('currency' => $order_capture->get_order_details()->get_currency())) ?>
                </div>
                <div class="qty-max bk-auto m-h-15">
                ...
                <div class="amount bk-auto m-h-15" style="margin-right:0">
                    <?php echo
                    wc_price($item->get_total_amount(), array('currency' => $order_capture->get_order_details()->get_currency())) ?>
                </div>
            </li>
        <?php
        }
        ...
        ?>
            <li class="bk-previous-capture">
                ...
                <div class="bk-refund-amount-wrap">
                    <div class="amount">
                        <?php echo
                        wc_price(str_replace(',', '.', $capture->get_total_amount()), array('currency' => $capture->get_currency())) ?>
                    </div>
                    <?php if (!in_array($capture->get_id(), $refunded_capture_ids)) {
                    ?>

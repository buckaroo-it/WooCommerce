jQuery(document).ready(function () {
  if (
    jQuery("label").first().attr("for") &&
    jQuery("label").first().attr("for").lastIndexOf("_")
  ) {
    //Setup Location
    ...
    if (locationName == "_mastersettings") {
      var exodusButton = document.getElementById(
        "woocommerce_buckaroo_mastersettings_exodus",
      );

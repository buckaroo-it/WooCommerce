jQuery(document).ready(function() {
    ...
    if (usemaster.length != 0){
        ...
        function togglelocal(checked){
            ...
            var currencyTR = document.querySelector("#woocommerce_buckaroo"+locationName+"_currency").closest('tr');
            ...
            if (checked == 1) {
                ...
                currencyTR.style.display = "table-row";

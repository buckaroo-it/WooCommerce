<?php
/**
 * WooCommerce BK_AJAX. AJAX Event Handlers.
 *
 * @class   BK_AJAX
...
class BK_AJAX {
	 ...
	 *
	 * @see BK_AJAX::json_search_products()
	 */
	 ...
	 */
	public static function capture_line_items() {
		ob_start();
		...
		$captured_amount        = isset( $_POST['captured_amount'] ) ? wc_format_decimal( sanitize_text_field( wp_unslash( $_POST['captured_amount'] ) ), wc_get_price_decimals() ) : 0;
		...
		try {
			...
			if ( wc_format_decimal( $order->get_total_refunded(), wc_get_price_decimals() ) !== $captured_amount ) {
	...
	public static function save_variations() {
		...
		$product_id                           = absint( $_POST['product_id'] );
		BK_Admin_Meta_Boxes::$meta_box_errors = array();
		WC_Meta_Box_Product_Data::save_variations( $product_id, get_post( $product_id ) );

		do_action( 'woocommerce_ajax_save_product_variations', $product_id );

		$errors = BK_Admin_Meta_Boxes::$meta_box_errors;
	 ...
	 *
	 * @uses BK_AJAX::variation_bulk_set()
	 * @uses BK_AJAX::variation_bulk_adjust_price()
	 * @uses BK_AJAX::variation_bulk_action_variable_sale_price_decrease()
	 * @uses BK_AJAX::variation_bulk_action_variable_sale_price_increase()
	 * @uses BK_AJAX::variation_bulk_action_variable_regular_price_decrease()
	 * @uses BK_AJAX::variation_bulk_action_variable_regular_price_increase()
	 * @uses BK_AJAX::variation_bulk_action_variable_sale_schedule()
	 * @uses BK_AJAX::variation_bulk_action_delete_all()
	 * @uses BK_AJAX::variation_bulk_action_variable_download_expiry()
	 * @uses BK_AJAX::variation_bulk_action_variable_download_limit()
	 * @uses BK_AJAX::variation_bulk_action_variable_height()
	 * @uses BK_AJAX::variation_bulk_action_variable_width()
	 * @uses BK_AJAX::variation_bulk_action_variable_length()
	 * @uses BK_AJAX::variation_bulk_action_variable_weight()
	 * @uses BK_AJAX::variation_bulk_action_variable_stock()
	 * @uses BK_AJAX::variation_bulk_action_variable_sale_price()
	 * @uses BK_AJAX::variation_bulk_action_variable_regular_price()
	 * @uses BK_AJAX::variation_bulk_action_toggle_manage_stock()
	 * @uses BK_AJAX::variation_bulk_action_toggle_virtual()
	 * @uses BK_AJAX::variation_bulk_action_toggle_downloadable()
	 * @uses BK_AJAX::variation_bulk_action_toggle_enabled
	 */

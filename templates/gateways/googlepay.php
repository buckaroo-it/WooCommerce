...
/**
 * The Template for the Google Pay standard checkout payment method
 * (classic / shortcode checkout).
 *
 * No Google Pay button is rendered here — the standard method is triggered from
...
?>
<div class="buckaroo-googlepay-checkout-method">
    <div class="googlepay-checkout-button-container"
         data-button-style="<?php echo esc_attr($buttonStyle); ?>"
         style="display:none;"></div>
    <input type="hidden" name="paymentData" class="buckaroo-googlepay-payment-data" value="" />
</div>

...
<p class="form-row form-row-wide validate-required">
    <label for="buckaroo-afterpay-b2b">
        <?php esc_html_e('Checkout for company', 'wc-buckaroo-bpe-gateway'); ?>
        <input 
...
<span id="showB2BBuckaroo" style="display:none">
    ...
    <p class="form-row form-row-wide validate-required">
        <label for="buckaroo-afterpay-company-coc-registration">
            <?php esc_html_e('COC (KvK) number:', 'wc-buckaroo-bpe-gateway'); ?><span class="required">*</span>
        </label>
        <input 
    ...
    <p class="form-row form-row-wide validate-required">
        <label for="buckaroo-afterpay-company-name">
            <?php esc_html_e('Name of the organization:', 'wc-buckaroo-bpe-gateway'); ?><span class="required">*</span>
        </label>
        <input 

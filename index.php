...
use Buckaroo\Woocommerce\Gateways\Klarna\KlarnaCapture;
use Buckaroo\Woocommerce\Gateways\Klarna\KlarnaKpGateway;
use Buckaroo\Woocommerce\Gateways\Klarna\KlarnaRefund;
...
//	$gateway_loader->load();
    ...
    {
        global $theorder;
        if (Config::get('enabled', 'payperemail') == 'yes') {
            if (in_array($theorder->get_status(), array('auto-draft', 'pending', 'on-hold'))) {
                if (Config::get('show_PayPerEmail', 'payperemail') == 'TRUE') {
            ...
            if (in_array($theorder->get_status(), array('pending', 'pending', 'on-hold', 'failed'))) {
                if (Config::get('show_PayLink', 'payperemail') == 'TRUE') {

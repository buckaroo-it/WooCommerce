...
class WC_Gateway_Buckaroo_PayGarant extends WC_Gateway_Buckaroo
{
    ...
    public function __construct()
    {
        ...
        if (version_compare(WOOCOMMERCE_VERSION, '2.0.0', '>=')) {
            ...
            if ($this->showpayproc) {
                add_action('woocommerce_thankyou_buckaroo_paygarant', array($this, 'thankyou_description'));
            }
    ...
    public function process_refund($order_id, $amount = null, $reason = '')
    {
        ...
        $paygarant->invoiceId              = $order->get_order_number() . '-' . time();
    ...
    public function process_payment($order_id)
    {
        ...
        $paygarant->invoiceId   = (string) getUniqInvoiceId($order->get_order_number());

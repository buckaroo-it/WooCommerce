    ...
    <ul>
        ...
        foreach ($items_to_capture['line_item'] as $item) {
            ...
            <li class="bk-to-capture">
                ...
                <div class="cost bk-auto m-h-15">
                    <?php
                    echo wc_price($item->get_unit_price(), ['currency' => $order_capture->get_order_details()->get_currency()])
                    ?>
                </div>
                <div class="qty-max bk-auto m-h-15">
                ...
                <div class="amount bk-auto m-h-15" style="margin-right:0">
                    <?php
                    echo wc_price($item->get_total_amount(), ['currency' => $order_capture->get_order_details()->get_currency()])
                    ?>
                </div>
            </li>
            <?php

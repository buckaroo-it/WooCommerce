...
class Buckaroo_Order_Details
{
     ...
     *
     * @return Buckaroo_Address_Components
     */
    public function get_billing_address_components(): Buckaroo_Address_Components
    {
        return new Buckaroo_Address_Components(
     ...
     * @return Buckaroo_Address_Components
     */
    public function get_shipping_address_components(): Buckaroo_Address_Components
    {
        return new Buckaroo_Address_Components(

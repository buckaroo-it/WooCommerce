...
namespace WC_Buckaroo\WooCommerce\PaymentMethods\Applepay;
...
class ApplePayGateway extends PaymentGatewayHandler
{
    ...
    public function createOrder($billing_addresses, $shipping_addresses, $items, $selected_method_id)
    {
        ...
        $wc_methods = self::createFakeCart($items, function () {

...
namespace WC_Buckaroo\WooCommerce\PaymentMethods\Afterpay;

use WC_Buckaroo\WooCommerce\Payment\AddressComponents;
use WC_Buckaroo\WooCommerce\PaymentMethods\PaymentGatewayHandler;

class AfterpayNewGateway extends PaymentGatewayHandler
{
    public $type;
    public $b2b;
